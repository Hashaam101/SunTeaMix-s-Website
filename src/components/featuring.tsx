...
function Featuring() {
  ...
  return (
    <div className='w-full'>
      ...
      <div className='text-center text-h2 text-black mb-12 md:mb-[80px]'>
        <div className=''>Best Boba & Dessert in Honolulu</div>
        <div className='text-normal2 sm:text-h5 mt-1 mx-2x'>Recommended Sample Text Placeholder</div>
      </div>
        ...
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:pl-8'>
            ...
            <div className='text-normal4 md:text-normal3 text-grey text-center lg:text-left'>
              Handcrafted with real fruit, premium teas, and fresh toppings.
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:pr-16'>
      ...
      >
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:ml-5'>
            ...
            Sun Tea Mix (绣蘭竹苑) is a family-run restaurant in Honolulu, Hawaii, known for serving real, traditional Taiwanese food.
            <br /><br />
      ...
      >
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:pr-16'>
            ...
            <div className='text-normal4 xl:text-normal3 text-grey text-center lg:text-left'>
              Sun Tea Mix Gives Back 10% To Help Your Non-Profit
              <br /><br />
